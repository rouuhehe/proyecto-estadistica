...
Encontramos tiempos de uso irrazonables, por lo que establecimos un máximo de 18 horas. Debido a esto, las filas fueron reducidas a 1029.
...
unique(DF_Normalizado$'Sistema operativo')
```
...
Dentro del nuevo dataframe 'DF_Objetivos' se separará la variable 'Factor importante' en 8 variables booleanas.
